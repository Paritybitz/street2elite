      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link href="/dashboard/children" className="text-slate-300 hover:text-white transition-colors">
              My Children
            </Link>
            <Link href="/dashboard/bookings" className="text-slate-300 hover:text-white transition-colors">
              Bookings
            </Link>
